...
def generate_dummy_sequence(num_samples=100, num_AR_coe=10, num_trials=10,
    ...
    sample_trial = sio.loadmat(
        '.\DaqMat\sample_3b12b_S2.mat')['trialData']
    sample_target = sio.loadmat('.\DaqMat\sample_3b12b_S2.mat')[
        'trialTargetness']
...
max_num_iter = 200
pow_non_target = [2, 8, 20, 40]
shift_offset_target = list(np.asarray([0.001, 16, 32, 50]) * 128 * 0.1)
